...
// // 打开的链接地址
// const openUrl = "http://http://192.168.1.227/:8083/dist/"
...
const openUrl = "https://s.kcimg.cn/dingtalk/js/v.2.1/"
...
// 20180227 新增 其他拜访类型
export function visibleAddotherFun(data, callback) {
    var url = getNeedUrl("visit/addother");
    var sign = getNeedUrlsign(url);
